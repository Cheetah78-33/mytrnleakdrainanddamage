...
export function CTABanner({ title = "Damage Doesn't Wait. Neither Do We.", sub = "Speak with a response coordinator now. Bay Area residential & commercial." }: { title?: string; sub?: string }) {
  return (
      ...
      <div className="relative mx-auto max-w-6xl overflow-hidden border border-gold glass-dark rounded-sm">
        ...
        <div className="relative px-6 py-16 md:py-20 text-center">
          <Reveal>
            ...
            <p className="mt-5 text-muted-foreground max-w-2xl mx-auto">{sub}</p>
            <div className="mt-9 flex flex-wrap gap-4 justify-center">
              <GoldLink href="tel:5107895001"><Phone className="h-4 w-4" /> Call 510-789-5001</GoldLink>
